...
const PatientAnalytics = () => {
  ...
  if (loading) {
    return (
      <div className={`min-h-screen flex items-center justify-center ${isDarkMode ? 'bg-black' : 'bg-gray-50'}`}>
        <div className="text-primary-500 text-xl animate-pulse font-bold">Loading analytics...</div>
      </div>
    );
  }
    ...
    if (active && payload && payload.length) {
      ...
      return (
        <div className="bg-white dark:bg-gray-900 p-3 rounded-lg shadow-xl border dark:border-gray-800">
          <p className="font-bold text-gray-800 dark:text-gray-100 mb-1">Attempt #{data.attempt}</p>
          <p className="text-sm">
  ...
  return (
    <div className={`min-h-screen p-4 md:p-6 transition-colors duration-500 ${isDarkMode ? 'bg-black text-white' : 'bg-gray-50 text-gray-800'}`}>
      <div className="max-w-7xl mx-auto">
        ...
        <div className="bg-white dark:bg-gray-900 rounded-3xl shadow-premium p-8 mb-8 border dark:border-gray-800">
          ...
          <div>
            <h1 className="text-4xl font-black text-gray-900 dark:text-white mb-2 tracking-tight">Patient Analytics</h1>
            <p className="text-gray-500 dark:text-gray-400 text-xl font-medium mb-3">{analytics.user.email}</p>
        ...
        <div className="grid lg:grid-cols-2 gap-8 mb-8">
          ...
          <div className="bg-white dark:bg-gray-900 rounded-3xl shadow-premium p-8 border dark:border-gray-800">
            <h2 className="text-2xl font-black text-gray-800 dark:text-white mb-2 tracking-tight">Response Time Analysis</h2>
          ...
          <div className="bg-white dark:bg-gray-900 rounded-3xl shadow-premium p-8 border dark:border-gray-800">
            <h2 className="text-2xl font-black text-gray-800 dark:text-white mb-2 tracking-tight">Session Performance</h2>
        ...
        <div className="grid lg:grid-cols-2 gap-8 mb-8">
          ...
          <div className="bg-white dark:bg-gray-900 rounded-3xl shadow-premium p-8 border dark:border-gray-800">
            <h2 className="text-2xl font-black text-gray-800 dark:text-white mb-2 tracking-tight">Overall Distribution</h2>
          ...
          <div className="bg-white dark:bg-gray-900 rounded-3xl shadow-premium p-8 border dark:border-gray-800">
            <h2 className="text-2xl font-black text-gray-800 dark:text-white mb-2 tracking-tight">Response Time Trend</h2>
        ...
        <div className="bg-white dark:bg-gray-900 rounded-3xl shadow-premium p-8 border dark:border-gray-800">
          <h2 className="text-2xl font-black text-gray-800 dark:text-white mb-6 tracking-tight">Session History</h2>
          <div className="overflow-x-auto">
            <table className="w-full">
              <thead>
                <tr className="border-b-2 border-gray-100 dark:border-gray-800">
                  <th className="text-left py-4 px-4 font-bold text-gray-500 dark:text-gray-400 uppercase tracking-wider text-xs">Date</th>
                  <th className="text-left py-4 px-4 font-bold text-gray-500 dark:text-gray-400 uppercase tracking-wider text-xs">Level Span</th>
                  <th className="text-left py-4 px-4 font-bold text-gray-500 dark:text-gray-400 uppercase tracking-wider text-xs">Attempts</th>
                  <th className="text-left py-4 px-4 font-bold text-gray-500 dark:text-gray-400 uppercase tracking-wider text-xs">Correct</th>
                  <th className="text-left py-4 px-4 font-bold text-gray-500 dark:text-gray-400 uppercase tracking-wider text-xs">Incorrect</th>
                  <th className="text-left py-4 px-4 font-bold text-gray-500 dark:text-gray-400 uppercase tracking-wider text-xs">Not Done</th>
                  <th className="text-left py-4 px-4 font-bold text-gray-500 dark:text-gray-400 uppercase tracking-wider text-xs">Accuracy</th>
                </tr>
              </thead>
              <tbody>
                {sessions.slice().reverse().map((session, index) => {
                  ...
                  return (
                    <tr key={index} className="border-b border-gray-100 dark:border-gray-800 hover:bg-gray-50 dark:hover:bg-gray-800/50 transition-colors">
                      <td className="py-4 px-4 text-sm font-medium">{new Date(session.time).toLocaleString()}</td>
                      ...
                      <td className="py-4 px-4 font-bold text-sm tracking-tight">{session.play.length}</td>
                      <td className="py-4 px-4">
                      ...
                      <td className="py-4 px-4">
                        <span className="font-black text-primary-600 dark:text-primary-400">{accuracy}%</span>
                      </td>
                    </tr>
                  );
                })}
        ...
        {showLevelSpanModal && (
          <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50 p-4">
            <div className="bg-white dark:bg-gray-900 rounded-3xl p-8 max-w-md w-full shadow-2xl border dark:border-gray-800">
              <h3 className="text-2xl font-black text-gray-800 dark:text-white mb-4 tracking-tight">Update Level Span</h3>
              ...
              <div className="mb-8">
                <label className="block text-xs font-black text-gray-400 uppercase tracking-widest mb-4">
                  Current Level Span: <span className="text-primary-500 text-3xl ml-2">{newLevelSpan}s</span>
                </label>
                <input
                  type="range"
                  min="1"
